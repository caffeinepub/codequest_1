...
const XP_PER_LEVEL = (level) => level === 20 ? 50 : 10;
const BADGES = [
  {
    id: "variable_hero",
    name: "Variable Hero",
...
const MC_C = [
  {
    type: "multichoice",
    question: "CodeBot needs to pick a path! Which C keyword checks a condition?",
...
function getChallenge(lang, level) {
  const data = ALL[lang];
...
function checkBadges(player, gameType) {
  var _a2, _b2, _c2;
  const newBadges = [];
  const total = Object.values(player.completedLevels).flat().length;
  const has = (id) => player.badges.includes(id);
  const check = (id, cond) => {
    if (cond && !has(id)) newBadges.push(id);
  };
  check(
    "variable_hero",
    ["C", "Python", "Java"].some((l) => {
      var _a3;
      return (_a3 = player.completedLevels[l]) == null ? void 0 : _a3.includes(1);
    })
  );
  check(
    "loop_master",
    ["C", "Python", "Java"].some((l) => {
      var _a3;
      return (_a3 = player.completedLevels[l]) == null ? void 0 : _a3.includes(5);
    })
  );
  check("bug_hunter", gameType === "fixbug");
  check("code_warrior", total >= 10);
  check("python_sage", (((_a2 = player.completedLevels["Python"]) == null ? void 0 : _a2.length) ?? 0) >= 20);
  check("c_champion", (((_b2 = player.completedLevels["C"]) == null ? void 0 : _b2.length) ?? 0) >= 20);
  check("java_jedi", (((_c2 = player.completedLevels["Java"]) == null ? void 0 : _c2.length) ?? 0) >= 20);
...
function Stars() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stars-bg", "aria-hidden": "true", children: stars.current.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "star",
      style: {
...
function TopBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "topbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.3rem" }, children: player.avatar }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pixel-xs", style: { color: "#8b5cf6" }, children: player.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "badge-pill gold", children: [
      "⭐ ",
      player.xp,
      " XP"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "badge-pill red", children: [
      "🔥 ",
      player.streak
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginLeft: "auto", display: "flex", gap: "0.5rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-sm", onClick: onDash, children: "Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-sm", onClick: onLeader, children: "Leaderboard" })
    ] })
  ] });
}
function LandingPage({ onStart }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-landing", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "landing-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "pixel-title neon-purple", children: [
        "CODE",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Learn to Code. Save the World."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-xl neon-btn", onClick: onStart, children: "▶ START ADVENTURE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "features-row", children: [
        ["🎮", "No Typing", "Pure gameplay"],
        ["🏆", "Level Up", "20 levels each"],
        ["🏅", "Earn Badges", "8 unique badges"]
      ].map(([icon, title, sub]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feature-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.8rem" }, children: icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600 }, children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("small", { style: { color: "#94a3b8" }, children: sub })
      ] }, title)) })
    ] })
  ] });
}
function OnboardingPage({ onComplete }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "pixel-sm neon-cyan", children: "CHOOSE YOUR HERO" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: AVATARS.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            "button",
            {
              ...
              onClick: () => {
                const p = {
                  ...
                  xp: 0,
                  streak: 1,
                  lastLogin: (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
...
function LanguageSelectPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, { player, onDash, onLeader }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-inner", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "pixel-sm neon-purple", style: { marginBottom: "2rem" }, children: "CHOOSE LANGUAGE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
          ...
          children: langs.map(({ lang, icon, color }) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "3rem" }, children: icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pixel-sm", style: { color }, children: lang }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { style: { color: "#94a3b8" }, children: [
                    done,
                    "/20 levels"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function WorldMapPage({
  ...
  const langColor = lang === "C" ? "#06b6d4" : lang === "Python" ? "#10b981" : "#fbbf24";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, { player, onDash, onLeader }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-inner", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-sm", onClick: onBack, children: "← Back" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pixel-xs", style: { color: langColor }, children: [
              lang,
              " WORLD MAP"
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "world-map-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "circle",
                        {
                          ...
                          cy: pos[1],
                          r: "4.2",
                          fill: done ? "#10b981cc" : isCurrent ? "#fbbf24cc" : "#1a1a2ecc",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "text",
                        {
                          ...
                          children: locked ? "🔒" : done ? "✓" : level
                        }
                      ),
                      !locked && /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: LEVEL_NAMES[level] })
                    ]
                  },
                  level
                );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Click a level node to play • 🔒 = locked • ✓ = completed"
        }
      )
    ] })
  ] });
...
function DragDropGame({
  ...
  const initOrder = reactExports.useRef(
    challenge.blocks.map((_, i) => i).sort(() => Math.random() - 0.5)
  );
  const [order, setOrder] = reactExports.useState(initOrder.current);
  const [dragging, setDragging] = reactExports.useState(null);
  const [submitted, setSubmitted] = reactExports.useState(false);
  const [resultShown, setResultShown] = reactExports.useState(false);
  const isCorrect = () => JSON.stringify(order) === JSON.stringify(challenge.correctOrder);
  const handleCheck = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-area", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "game-task", children: challenge.task }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#94a3b8", fontSize: "0.8rem" }, children: "Drag blocks to reorder them:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "drag-zone", children: order.map((origIdx, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: challenge.blocks[origIdx]
      },
      i
    )) }),
    !submitted && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn neon-btn", onClick: handleCheck, children: "CHECK ORDER ✓" })
  ] });
}
function MultiChoiceGame({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-area", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "game-task", children: challenge.question }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "choices-grid", children: challenge.options.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
...
function FixBugGame({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-area", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "game-task", children: challenge.task }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("pre", { className: "code-display", children: [
      challenge.code,
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#f87171", fontStyle: "italic" }, children: [
        " ",
        "← 🐛 BUG HERE"
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#94a3b8", fontSize: "0.8rem" }, children: "Choose the fix:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "choices-grid", children: challenge.options.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        className: `choice-btn${selected === i ? i === challenge.correct ? " correct" : " wrong" : ""}`,
...
function GameplayPage({
  ...
  const [confetti] = reactExports.useState(
  ...
  const handleResult = (correct) => {
    ...
    if (correct) {
      ...
      const updatedLevels = {
        ...
        [lang]: player.completedLevels[lang].includes(level) ? player.completedLevels[lang] : [...player.completedLevels[lang], level]
      };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-inner", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-sm", onClick: onBack, children: "← Map" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pixel-xs", style: { color: "#8b5cf6" }, children: [
              "Level ",
              level,
              ": ",
              LEVEL_NAMES[level]
            ...
            isAlreadyDone && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-pill green", children: "✓ DONE" })
          ]
        }
      ),
      showConfetti && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "confetti-zone", "aria-hidden": "true", children: confetti.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "type-tag", children: challenge.type === "dragdrop" ? "🧩 Drag & Drop" : challenge.type === "multichoice" ? "🎯 Multiple Choice" : "🐛 Fix the Bug" }),
        challenge.type === "dragdrop" && /* @__PURE__ */ jsxRuntimeExports.jsx(DragDropGame, { challenge, onResult: handleResult }),
        challenge.type === "multichoice" && /* @__PURE__ */ jsxRuntimeExports.jsx(MultiChoiceGame, { challenge, onResult: handleResult }),
        challenge.type === "fixbug" && /* @__PURE__ */ jsxRuntimeExports.jsx(FixBugGame, { challenge, onResult: handleResult }),
        result === true && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-box result-correct", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pixel-xs", style: { color: "#6ee7b7" }, children: [
            "🎉 CORRECT! +",
            xpReward,
            " XP!"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn neon-btn", onClick: onBack, children: "NEXT LEVEL →" })
        ] }),
        result === false && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-box result-wrong", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pixel-xs", style: { color: "#fca5a5" }, children: "❌ Not quite!" }),
          showHint && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hint-box", children: [
            "💡 Hint: ",
            challenge.hint
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function DashboardPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, { player, onDash, onLeader }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-inner", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "pixel-sm neon-purple", style: { marginBottom: "1.5rem" }, children: "HERO DASHBOARD" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dash-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "card",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "3rem" }, children: player.avatar }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pixel-xs", style: { color: "#8b5cf6" }, children: player.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "pixel-xs",
                  style: { color: "#fbbf24", fontSize: "0.5rem" },
                  children: getLevelTitle(player.xp)
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
          ...
          ["C", "Python", "Java"].map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { minWidth: "70px" }, children: [
                  lang === "C" ? "⚙️" : lang === "Python" ? "🐍" : "☕",
                  " ",
                  lang
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar", style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "progress-fill",
                    style: {
                      width: `${player.completedLevels[lang].length / 20 * 100}%`,
                      background: lang === "C" ? "#06b6d4" : lang === "Python" ? "#10b981" : "#fbbf24"
                    }
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#94a3b8", minWidth: "40px" }, children: [
                  player.completedLevels[lang].length,
                  "/20"
                ] })
              ]
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "badges-grid", children: BADGES.map((badge) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2rem" }, children: BADGE_ICONS[badge.id] || "🏅" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "pixel-xs",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-inner", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-sm", onClick: onBack, children: "← Back" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "pixel-sm neon-yellow", children: "LEADERBOARD" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: all.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.4rem" }, children: p.avatar }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { flex: 1 }, children: [
                  p.name,
                  " ",
                  p.name === player.name ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
...
function App() {
  const [player, setPlayer] = reactExports.useState(loadPlayer);
  const [page, setPage] = reactExports.useState("landing");
  const [selectedLang, setSelectedLang] = reactExports.useState("Python");
  const [selectedLevel, setSelectedLevel] = reactExports.useState(1);
  const [badgePopup, setBadgePopup] = reactExports.useState([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    badgePopup.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "badge-popup", onClick: () => setBadgePopup([]), children: [
      badgePopup.map((id) => {
        const b = BADGES.find((x) => x.id === id);
        return b ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "badge-popup-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "4rem" }, children: BADGE_ICONS[id] || "🏅" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pixel-xs", style: { fontSize: "0.55rem" }, children: "NEW BADGE!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: b.name })
        ] }, id) : null;
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("small", { style: { color: "#94a3b8" }, children: "Tap to close" })
    ] }),
    page === "landing" && /* @__PURE__ */ jsxRuntimeExports.jsx(LandingPage, { onStart: handleStart }),
    page === "onboarding" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      OnboardingPage,
      {
        onComplete: (p) => {
          setPlayer(p);
    ...
    page === "languageSelect" && player && /* @__PURE__ */ jsxRuntimeExports.jsx(
      LanguageSelectPage,
      {
        player,
        onSelect: (l) => {
    ...
    page === "worldMap" && player && /* @__PURE__ */ jsxRuntimeExports.jsx(
      WorldMapPage,
      {
        player,
        lang: selectedLang,
    ...
    page === "gameplay" && player && /* @__PURE__ */ jsxRuntimeExports.jsx(
      GameplayPage,
      {
        player,
        lang: selectedLang,
    ...
    page === "dashboard" && player && /* @__PURE__ */ jsxRuntimeExports.jsx(
      DashboardPage,
      {
        player,
    ...
    page === "leaderboard" && player && /* @__PURE__ */ jsxRuntimeExports.jsx(LeaderboardPage, { player, onBack: () => go("dashboard") })
  ] });
}
